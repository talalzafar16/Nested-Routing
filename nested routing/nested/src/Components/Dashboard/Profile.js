  ...
  return (
    <div className="full">
      ...
      <Button onClick={()=>navigate("/Dashboard")} variant="contained"sx={{marginLeft:"20px",marginTop:"10px"}}>Back to Dashboard</Button>
        <Typography  variant="h3" sx={{color:"white",marginLeft:"470px",marginTop:"-24px",fontFamily:"'Times New Roman', Times, serif", fontSize:" 60px" }}>Welcome to Profile</Typography></div>
        <div className="center">
            <Typography sx={{color:"black",fontWeight:"bold",fontFamily:"'Times New Roman', Times, serif", fontSize:" 42px" }} variant="h4"> This is your Profile</Typography>
      ...
      <div className="vertical">
        <hr className="lines"/>
        <Typography sx={{marginLeft:"49px",color: 'white'}}variant="h6">Profile</Typography>
